      ...
      <section className="hero-section relative overflow-hidden text-white">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.15] tracking-tight mb-6">
            世界のクリプトカードを<br className="hidden sm:block" />
          ...
          <p className="text-lg sm:text-xl text-slate-300 leading-relaxed mb-10 max-w-2xl mx-auto">
            手数料・還元率・対応地域・日本対応有無を中立的に整理。<br className="hidden sm:block" />
            あなたに合ったカードを、自分で選んでください。
          </p>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4 p-4 sm:p-5">
                    ...
                    {/* Card logo */}
                    <div className={`w-12 h-12 bg-gradient-to-br ${card.coverColor} rounded-xl flex items-center justify-center text-2xl flex-shrink-0 shadow-sm`}>
                      {card.logo}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap mb-0.5">
                        ...
                        {card.keyStrength && (
                          <span className="hidden sm:inline-flex items-center text-xs bg-blue-50 text-blue-700 border border-blue-100 px-2 py-0.5 rounded-full font-medium">
                            {card.keyStrength}
                          </span>
                        )}
                        {card.isSponsor && (
                      ...
                      <p className="text-xs text-slate-500 line-clamp-1 sm:line-clamp-none">{entry.reason}</p>
                    </div>
                    ...
                    <div className="hidden md:flex items-center gap-4 flex-shrink-0 text-right">
                      <div>
                        ...
                        <p className="text-sm font-semibold text-slate-800 whitespace-nowrap">{card.fxFee.split("、")[0].split("（")[0]}</p>
                      </div>
                      <div>
                        <p className="text-xs text-slate-400">還元率</p>
                        <p className="text-sm font-semibold text-slate-800">{card.cashbackRate}</p>
                      </div>
                    </div>
                    ...
                    <Link
                      ...
                      className="hidden sm:flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50 transition-colors flex-shrink-0"
                    >
                  ...
                  <div className="sm:hidden px-4 pb-4 flex items-center justify-between">
                    <div className="flex gap-4">
                      <div>
                        <p className="text-xs text-slate-400">FX手数料</p>
                        <p className="text-xs font-semibold text-slate-700">{card.fxFee.split("、")[0].split("（")[0]}</p>
                      </div>
                      <div>
                        <p className="text-xs text-slate-400">還元率</p>
                        <p className="text-xs font-semibold text-slate-700">{card.cashbackRate}</p>
                      </div>
                    </div>
                    <Link
                      href={`/cards/${card.slug}`}
